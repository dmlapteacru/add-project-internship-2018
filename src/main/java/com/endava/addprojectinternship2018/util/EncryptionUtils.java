...
public class EncryptionUtils {
    ...
    public void init(byte[] bankModulus, byte[] privateKey) throws InvalidKeySpecException {
        if (bankModulus != null)
    ...
    public void init(BankKey bankKey) throws InvalidKeySpecException, InvalidKeyException {
        init(bankKey.getModulus(), bankKey.getPrivateKey());
    }
    ...
    private void initDecrypter(byte[] privateKeyBytes) throws InvalidKeySpecException {
    ...
    private void initEncrypter(byte[] modulusBase64) throws InvalidKeySpecException {
